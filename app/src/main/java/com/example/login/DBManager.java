...
public class DBManager {
    ...
    public void insert(String full_name, int age, String dose, String vaccine) {
        try {
    ...
    public Cursor fetch() {
        String [] columns  = new String[] {DBHelper.COL_ID, DBHelper.COL_FULL_NAME, DBHelper.COL_AGE, DBHelper.COL_DOSE, DBHelper.COL_VACCINE};
